...
function showcase() {
    ...
    item.forEach((element, index) => {
        ListTag += `<li>
                        ...
                        <span class="icon">
                            <i class="del uil uil-plus-circle" style="color:red" onclick="deleteTask(${index})"></i>
                        <span>
                    </li>`;
    });
...
// "Complete all tasks"  is used for delete all task from your list
clearall.onclick = () => {
...
// "Clear Completed" is used to delete checked tasks from list.
...
// "Completed" is used to check all tasks
document.querySelector('.complete').onclick = () => {
    checked(true);
}


//"Uncomplete"  used to unchecked  all the checked tasks
